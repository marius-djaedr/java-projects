...
public class ButtonColumn extends AbstractCellEditor implements TableCellRenderer, TableCellEditor, ActionListener, MouseListener {
	private static final long serialVersionUID = -2709429344081204847L;
	 ...
	 *  @param actionIn the Action to be invoked when the button is invoked
	 *  @param column the column to which the button renderer/editor is added
	 */
	@SuppressWarnings("serial")
	public ButtonColumn(final JTable table, final ActionListener actionIn, final int column) {
		this.table = table;
		this.action = new AbstractAction() {
			@Override
			public void actionPerformed(final ActionEvent e) {
				actionIn.actionPerformed(e);
			}
		};
